...
var classList = [
    {
        ...
        "hp": "<p><strong>Hit Dice</strong> 1d12</p><p><strong>Hit Dice as 1st level</strong> 12 + your Constitution modifier</p><p><strong>Hit Dice at higher levels</strong> 1d12 (or 7) + your Constitution modifier per barbarian level after 1st</p>",
        "prof":"<p><strong>Armour:</strong> Light armor, medium armor, shields</p><p><strong>Weapons:</strong> Simple weapons, martial weapons</p><p><strong>Tools:</strong> None</p><p><strong>Saving Throws:</strong> Strength, Constitution</p><p><strong>Skills:</strong> Choose two from Animal Handling, Athletics, Intimidation, Nature, Perception, and Survival</p>",
        "equipment": "<p>You start with the following equipment, in addition to the equipment granted by your background:</p><ul><li>(a) a greataxe or (b) any martial melee weapon</li><li>(a) two handaxes or (b) any simple weapon</li><li>An explorer's pack and four javelins</li></ul>",
